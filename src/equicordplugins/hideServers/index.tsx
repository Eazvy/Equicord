...
export default definePlugin({
    name: "HideServers",
    description: "Allows you to hide servers & folders from the guild list and quick switcher by right clicking them",
    authors: [EquicordDevs.bep, EquicordDevs.omaw],
